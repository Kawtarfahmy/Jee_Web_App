...
import org.sid.ebankingbackend.dtos.AccountOpreationDTO;
...
public class BankAccountMapperImpl {
    ...
    public AccountOpreationDTO fromAccountOperation(AccountOpreation accountOpreation){
        AccountOpreationDTO accountOpreationDTO= new AccountOpreationDTO();
        BeanUtils.copyProperties(accountOpreation,accountOpreationDTO);
        return accountOpreationDTO;
    }
